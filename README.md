...
vector-backed implementation, and Mosh packet nonce construction is modeled.
UDP transport, SSP, wire codecs, encrypted packet fixtures, and terminal state
synchronization are still pending.
